...
namespace df
{
    ...
    EventMouse::EventMouse() : m_mouse_action{UNDEFINED_MOUSE_ACTION}, m_mouse_button{sf::Mouse::Button::ButtonCount}
    {
        setType(MSE_EVENT);
    }
    ...
    void EventMouse::setMouseButton(sf::Mouse::Button new_mouse_button)
    {
        m_mouse_button = new_mouse_button;
    }

    sf::Mouse::Button EventMouse::getMouseButton() const
    {
